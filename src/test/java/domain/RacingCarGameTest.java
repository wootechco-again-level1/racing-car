...
class RacingCarGameTest {
    ...
    void playTest() {
        ...
        List<OneRound> rounds = RacingCarGame.play(cars, countOfGame, sevenGenerator).getRounds();
        Map<String, Integer> finalRoundStatus = rounds.get(4).getCarStatuses(); // countOfGame = 5, finalRoundIndex = 4
